...
ENV FISHEYE_DOWNLOAD_URL         "https://downloads.atlassian.com/software/fisheye/downloads/fisheye-4.6.0.zip"
...
RUN set -ex \
    ...
    && tar zxf $ARCHIVE --strip-components=1 -C $FISHEYE_CATALINA/lib/ mysql-connector-java-8.0.11/mysql-connector-java-8.0.11.jar \
    && rm -rf $ARCHIVE
